...
class Interceptor extends \Magento\Store\Block\Switcher implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getCurrentWebsiteId()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCurrentWebsiteId();
        } else {
            return $this->___callPlugins('getCurrentWebsiteId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrentGroupId');
        if (!$pluginInfo) {
            return parent::getCurrentGroupId();
        } else {
            return $this->___callPlugins('getCurrentGroupId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRawGroups');
        if (!$pluginInfo) {
            return parent::getRawGroups();
        } else {
            return $this->___callPlugins('getRawGroups', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRawStores');
        if (!$pluginInfo) {
            return parent::getRawStores();
        } else {
            return $this->___callPlugins('getRawStores', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrentStoreCode');
        if (!$pluginInfo) {
            return parent::getCurrentStoreCode();
        } else {
            return $this->___callPlugins('getCurrentStoreCode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isStoreInUrl');
        if (!$pluginInfo) {
            return parent::isStoreInUrl();
        } else {
            return $this->___callPlugins('isStoreInUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getStoreCode()
    {
        ...
        if (!$pluginInfo) {
            return parent::getStoreCode();
        } else {
            return $this->___callPlugins('getStoreCode', func_get_args(), $pluginInfo);
        }
    }
