...
class Interceptor extends \Magento\Store\Model\Group implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getDefaultStoreByLocale($locale)
    {
        ...
        if (!$pluginInfo) {
            return parent::getDefaultStoreByLocale($locale);
        } else {
            return $this->___callPlugins('getDefaultStoreByLocale', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getStoresByLocale($locale)
    {
        ...
        if (!$pluginInfo) {
            return parent::getStoresByLocale($locale);
        } else {
            return $this->___callPlugins('getStoresByLocale', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setDefaultStoreId($defaultStoreId)
    {
        ...
        if (!$pluginInfo) {
            return parent::setDefaultStoreId($defaultStoreId);
        } else {
            return $this->___callPlugins('setDefaultStoreId', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setRootCategoryId($rootCategoryId)
    {
        ...
        if (!$pluginInfo) {
            return parent::setRootCategoryId($rootCategoryId);
        } else {
            return $this->___callPlugins('setRootCategoryId', func_get_args(), $pluginInfo);
        }
    }
