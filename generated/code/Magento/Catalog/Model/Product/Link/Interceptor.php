...
class Interceptor extends \Magento\Catalog\Model\Product\Link implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function useRelatedLinks()
    {
        ...
        if (!$pluginInfo) {
            return parent::useRelatedLinks();
        } else {
            return $this->___callPlugins('useRelatedLinks', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function useUpSellLinks()
    {
        ...
        if (!$pluginInfo) {
            return parent::useUpSellLinks();
        } else {
            return $this->___callPlugins('useUpSellLinks', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function useCrossSellLinks()
    {
        ...
        if (!$pluginInfo) {
            return parent::useCrossSellLinks();
        } else {
            return $this->___callPlugins('useCrossSellLinks', func_get_args(), $pluginInfo);
        }
    }
