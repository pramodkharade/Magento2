...
class Interceptor extends \Magento\Catalog\Model\ResourceModel\Product\Compare\Item\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function setVisitorId($visitorId)
    {
        ...
        if (!$pluginInfo) {
            return parent::setVisitorId($visitorId);
        } else {
            return $this->___callPlugins('setVisitorId', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getVisitorId()
    {
        ...
        if (!$pluginInfo) {
            return parent::getVisitorId();
        } else {
            return $this->___callPlugins('getVisitorId', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getConditionForJoin()
    {
        ...
        if (!$pluginInfo) {
            return parent::getConditionForJoin();
        } else {
            return $this->___callPlugins('getConditionForJoin', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function _addJoinToSelect()
    {
        ...
        if (!$pluginInfo) {
            return parent::_addJoinToSelect();
        } else {
            return $this->___callPlugins('_addJoinToSelect', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getComparableAttributes()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getComparableAttributes', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function loadComparableAttributes()
    {
        ...
        if (!$pluginInfo) {
            return parent::loadComparableAttributes();
        } else {
            return $this->___callPlugins('loadComparableAttributes', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function useProductItem()
    {
        ...
        if (!$pluginInfo) {
            return parent::useProductItem();
        } else {
            return $this->___callPlugins('useProductItem', func_get_args(), $pluginInfo);
        }
    }
