...
class Interceptor extends \Magento\Store\Model\ResourceModel\Store implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'readAllStores');
        if (!$pluginInfo) {
            return parent::readAllStores();
        } else {
            return $this->___callPlugins('readAllStores', func_get_args(), $pluginInfo);
        }
    }
